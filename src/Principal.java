...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        Produto produto2 = new Produto("Calça Jeans", 5, 59.99f, 2);
        Produto produto3 = new Produto("Tênis", 8, 79.99f, 3);
        Produto produto4 = new Produto("Boné", 20, 9.99f, 4);
        Produto produto5 = new Produto("Relógio", 3, 199.99f, 5);
        ...
        ArrayList<Item> produtosPedido = new ArrayList<>(); // Supondo que a classe Item esteja definida

        Pedido pedido1 = new Pedido(endereco1, cartao1, 1, "Entregue", produtosPedido);
        Pedido pedido2 = new Pedido(endereco2, cartao2, 2, "Enviado", produtosPedido);
